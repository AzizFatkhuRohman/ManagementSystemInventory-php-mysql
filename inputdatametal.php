...
if(isset($_POST['submit'])){
    ...
    $qty=$_POST['qty'];
    if(empty($kode_barang) || empty($nama_barang) || empty($jenis_barang) || empty($qty)) {	
			echo "<script>alert('Kolom tidak boleh kosong')</script>";
    } else {	
          $sql="insert into `tb_metal` (kode_barang,nama_barang,jenis_barang,qty) values 
          ('$kode_barang','$nama_barang','$jenis_barang','$qty')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            <div id="content">
                ...
                <div class="text-center">
                    <span><b>Input</b> Data Metal</span>
                </div>
