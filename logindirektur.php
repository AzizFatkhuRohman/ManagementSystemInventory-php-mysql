<?php
session_start();
$username = 'siti siyami';
$password = 'siti siyami';
        ...
        <div class="container" data-aos="fade-up">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <div>
                        <h5 style='color: yellow;'>Log In Direktur</h5>
                    </div>
                    <form method='post'>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            <input type="submit" name='admin' value='Log In' class="btn btn-outline-warning"
