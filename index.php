        ...
        <div class="container" data-aos="fade-up">
            <div class="row justify-content-center">
                <div class="col-lg-6 text-center">
                    <h3>Sistem Informasi Inventory Barang Metal</h3>
                    <p>Dengan Teknologi Semua Menjadi Lebih Mudah</p>
                </div>
            </div>
            ...
            <div class="container">
                <div class="row gy-4">
                    <div class="col-lg-5 col-md-12 footer-info">
                        ...
                        <p>SIIBM adalah Web Aplikasi untuk mempermudah pengelolaan barang metal.<br>
