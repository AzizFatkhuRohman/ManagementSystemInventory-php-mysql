                            ...
                            <table class="table">
                                ...
                                <tbody>
                                    <tr>
                                        <?php
           include 'database.php';
            $result = mysqli_query($conn, "SELECT * FROM tb_metal ORDER BY id DESC");
            while($res = mysqli_fetch_array($result))
            {
                      ?>
                                        ...
                                        <td>
                                            <?php
              echo"<a href=\"updatemetal.php?id=$res[id]\" type='button' class='btn btn-outline-success'>Update</a>";
              echo"<a href=\"deletemetal.php?id=$res[id]\" type='button' class='btn btn-outline-danger' onClick=\"return confirm('Are you sure you want to delete?')\">Delete</a></td>";
                ?>
                                    </tr>
                                    <?php
          }
